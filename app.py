...
MONGODB_CONNECTION_STRING = "mongodb://anisah:user@ac-ehbabt3-shard-00-00.ikc58s9.mongodb.net:27017,ac-ehbabt3-shard-00-01.ikc58s9.mongodb.net:27017,ac-ehbabt3-shard-00-02.ikc58s9.mongodb.net:27017/?replicaSet=atlas-dpl8po-shard-0&ssl=true&authSource=admin&retryWrites=true&w=majority&appName=Cluster0"
...
def get_posts():
    ...
    try:
        ...
        for post in posts:
            ...
            post['count_thumbsup'] = db.likes.count_documents({'post_id': post['_id'], 'type': 'thumbs-up'})
            ...
            post['thumbsup_by_me'] = bool(db.likes.find_one({'post_id': post['_id'], 'type': 'thumbs-up', 'username':payload['id']}))
